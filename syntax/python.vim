...
" by wxnacy begin {{{
syn keyword pythonValue	        False None True
syn keyword pythonParam	        self cls
syn keyword pythonBuiltinVar	__name__ __file__
...
hi def link pythonValue         Underlined
hi def link pythonParam         Type
hi def link pythonConditional	Special
