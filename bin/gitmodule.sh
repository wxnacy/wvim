...
git submodule add --force https://github.com/francoiscabrol/ranger.vim         bundle/ranger.vim              # ranger 插件
...
git submodule add --force https://github.com/preservim/tagbar                  bundle/tagbar                  # 文件标签菜单
git submodule add --force https://github.com/SirVer/ultisnips                  bundle/ultisnips               # 代码片段
...
# git submodule add --force https://github.com/mxw/vim-jsx.git                   bundle/vim-jsx                 # react                语法高亮
